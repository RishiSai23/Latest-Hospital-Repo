...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Title -->
        <title>Evercare - Free Medical and Doctor Directory HTML Template.</title>
								...
								<div class="single-main">
									...
									<div class="news-text">
										...
										<blockquote class="overlay">
											<p> It is essential to emphasize that this article only captured trials listed in the clinicaltrials.gov database. We identified 24 clinical trials, involving more than 20 medicines, such as human immunoglobulin, interferons, chloroquine, hydroxychloroquine, arbidol, remdesivir, favipiravir, lopinavir, ritonavir, oseltamivir, methylprednisolone, bevacizumab, and traditional Chinese medicines (TCM). Although drug repurposing has some limitations, repositioning clinical trials may represent an attractive strategy because they facilitate the discovery of new classes of medicines; they have lower costs and take less time to reach the market and there are existing pharmaceutical supply chains for formulation and distribution.</p>					
										</blockquote>
										<p style="color:black;"> Drug repositioning for other neglected diseases is an essential and universal strategy in the development of new drugs due to lower costs and reduced time to reach the market because some clinical trial steps might not be required, especially concerning phases I and II existing pharmaceutical supply chains are available for formulation and distribution the possibility of combinations with other drugs in treatments that are more effective than monotherapy and may facilitate the discovery of new mechanisms of action for old drugs and new classes of medicines.</p>
									</div>
										...
										<div class="single-comments">
											<div class="main">
												...
												<div class="body">
													...
													<p> But the majority have suffered from various sideeffects....</p>
										...
										<div class="single-comments left">
											<div class="main">
												...
												<div class="body">
													<h4>Naimur Rahman</h4>
													<div class="comment-meta"><span class="meta"><i class="fa fa-calendar"></i>March 05, 2019</span><span class="meta"><i class="fa fa-clock-o"></i>03:38 AM</span></div>
													<p> I think its a great idea to eradicate the problem.</p>
													<a href="#"><i class="fa fa-reply"></i>replay</a>
												</div>
											</div>
										</div>		
						...
						<div class="main-sidebar">
							...
							<div class="single-widget category">
								...
								<ul class="categor-list">
									<li><a href="#">Latest medical news</a></li>
									<li><a href="#">Medicinal advancements</a></li>
									<li><a href="#">Infections across the globe</a></li>
									<li><a href="#">Know your medicines</a></li>
									<li><a href="#">Know your body</a></li>
								</ul>
							</div>
							<!--/ End Single Widget -->
							<!-- Single Widget -->
